      ...
      <div className="max-w-6xl mx-auto space-y-20">
          ...
          <section className="flex flex-col md:flex-row items-center gap-12 pt-10">
            ...
            <div className="space-y-4">
              ...
              <p className="text-normal-text leading-relaxed max-w-xl">
                Frontend developer from Oslo, combining a background in design
                and computer technology to build clean, accessible interfaces.
              </p>
            </div>
          </section>
        </FadeUp>
        ...
        <FadeUp>
          ...
          <section className="grid md:grid-cols-3 gap-2">
            ...
            <p className="md:col-span-2 text-normal-text leading-relaxed">
              Building interfaces that are intuitive and accessible to everyone.
              I try to keep code maintainable and easy to build on, keep up with
              new tools, and care about the details that make an experience feel
              right.
            </p>
          </section>
        </FadeUp>
        ...
        <FadeUp>
          ...
          <section className="grid md:grid-cols-3 gap-2">
            ...
            <p className="md:col-span-2 text-normal-text leading-relaxed">
              ...
              <br />
              <br />
              <span className="text-normal-text leading-relaxed flex items-center gap-2">
