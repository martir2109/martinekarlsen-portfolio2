      ...
      <FadeUp>
        <div className="space-y-2">
          ...
          <p className="text-normal-text leading-relaxed">
            A full-featured social media application where users can create,
            edit, and delete posts, follow and unfollow others, leave comments,
            and react to content.
          </p>
        </div>
      </FadeUp>
      ...
      <FadeUp>
        ...
        <div className="grid md:grid-cols-3 gap-2">
          ...
          <p className="md:col-span-2 text-normal-text leading-relaxed">
            I was given the task to create a social media application where
            users can perform full CRUD operations on their posts (Create, Read,
            Update and Delete). In addition, users can follow and unfollow each
            other, comment on posts, and react with an emoji.
          </p>
        </div>
      </FadeUp>
