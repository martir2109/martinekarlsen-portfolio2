      ...
      <FadeUp>
        <div className="space-y-2">
          ...
          <p className="text-normal-text leading-relaxed">
            An auction web application where registered users can manage
            profiles, create and bid on listings, and track bid history, while
            guests can browse and search without an account. Built with a
            mobile-first, responsive design using full CRUD functionality.
          </p>
        </div>
      </FadeUp>
      ...
      <FadeUp>
        ...
        <div className="grid md:grid-cols-3 gap-2">
          ...
          <p className="md:col-span-2 text-normal-text leading-relaxed">
            ...
            search and view listings without logging in. The application follows
            a mobile-first approach and features a clean, responsive interface
            across all devices.
          </p>
        </div>
      </FadeUp>
          ...
          <p className="md:col-span-2 text-normal-text">
            <div className="flex flex-col gap-2 md:col-span-2 text-normal-text">
              ...
              <p>
                ...
                description, and a decorative label above it. Improved the
                buttons with better sizing and hover effects, and cleaned up the
