      ...
      <FadeUp>
        <div className="space-y-2">
          ...
          <p className="text-normal-text leading-relaxed">
            ...
            pages, a shopping cart, checkout flow, a contact form, and full
      ...
      <FadeUp>
        ...
        <div className="grid md:grid-cols-3 gap-2">
          ...
          <p className="md:col-span-2 text-normal-text leading-relaxed">
            ...
            React and Next.js. The app fetches products from a REST API,
            displays them in a user-friendly layout, and includes a complete
            shopping cart and checkout flow. The site also features a validated
            contact form and is fully responsive on both desktop and mobile.
          </p>
        </div>
      </FadeUp>
          ...
          <p className="md:col-span-2 text-normal-text">
            <div className="flex flex-col gap-2 md:col-span-2 text-normal-text">
              ...
              <p>
                ...
                with an image zoom. Improved the product list filters and search
                bar with consistent styling and better usability. Enhanced the
                home page banner with a dark overlay, a "Shop now" button, and
